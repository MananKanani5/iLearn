  ...
  return (
    ...
    <>
      <section className="px-8 max-sm:px-5 py-12  bg-[#fff7f2] m-z fade-in flex justify-between flex-wrap max-sm:flex-col-reverse">
        <div className="sm:w-[73%] w-full shadow-md rounded-2xl bg-white px-14 max-sm:px-5 py-14 max-sm:my-5 ">
          ...
          <div>
            ...
            <h1 className="text-xl font-semibold mb-14 pt-10 leading-normal text-Secondary-color max-sm:text-lg">
              1. Assignment One - Lorem ipsum sit amet consectetur, adipisicing
              elit. Dolorem corporis ducimus sequi, enim sint ipsam porro
              cupiditate? Animi, dolore sequi.
            </h1>
            <div className={`${assignmentinfo}`}>
              ...
              <p className="Description text-justify mb-10">
                ...
                eius iste rem ab? Minus fugit praesentium sapiente alias sed
                rerum provident ipsam, sequi blanditiis culpa, ad quia eius cum
                ratione a voluptatem hic cumque nesciunt dicta nemo. Totam
                incidunt eius aut cumque ab accusantium, ipsa provident
                reiciendis doloremque inventore, reprehenderit consequuntur ad
                voluptates odit. Praesentium iste quidem eligendi sit veniam?
                Non minima minus perspiciatis facilis dignissimos harum
                voluptates quo, explicabo inventore vitae laboriosam. Sit,
                praesentium dolor beatae ullam unde, adipisci illum ratione ex
                iure ut facilis exercitationem esse ad atque nihil earum
                blanditiis, aliquam dignissimos quod ducimus! Ullam itaque a ea
                ipsa quod quo adipisci enim quis voluptatibus esse. Temporibus
                error quasi iste exercitationem possimus iure repellendus modi
                placeat totam voluptatibus vero, sunt, eligendi magni rerum
                doloribus, voluptatem reiciendis! Pariatur, expedita ad
                voluptatem distinctio quo vero aspernatur exercitationem
                perferendis corporis alias similique delectus dolor qui autem
                non doloribus ducimus nobis sint facilis incidunt odit saepe
                maxime numquam! Laboriosam quisquam velit voluptate ea tempora,
                ad, aliquam autem hic libero officia doloremque animi quaerat
                voluptas harum quasi tenetur impedit earum sequi vel dicta
                dolore assumenda repellendus! Placeat eaque doloribus dolore
                itaque eligendi ullam obcaecati suscipit recusandae
                consequuntur, harum iusto quisquam, quidem.
              </p>
          ...
          <div className=" pt-14 max-sm:my-5 mt-8">
            <button
              onClick={showSubm}
              className="hambuger w-full my-2 flex justify-between items-center"
            >
              <span className="text-2xl font-bold uppercase text-Secondary-color ">
                Submission
              </span>
              ...
              <div className="text-Secondary-color">
                <i
                  className={` ${
                    subm === "hidden" ? "block" : "hidden"
                  } fa fa-angle-right text-2xl `}
                ></i>

                <i
                  className={` ${
                    subm === "hidden" ? "hidden" : "block"
                  } fa fa-angle-down text-2xl `}
                ></i>
              </div>
            </button>
        ...
        <thead>
          <tr>
            <th className="border border-[#d5d5d5] rounded-2xl p-3">Studet Name</th>
