...
const StudentRole = () => {
  return (
    <>
      ...
      <NavLink  style={({ isActive }) => ({
          color: isActive ? '#f36730' : '',
        })} to={""} className="hover:text-Primary-color transition ease-in-out duration-400 font-semibold">Quiz</NavLink>
      <NavLink  style={({ isActive }) => ({
          color: isActive ? '#f36730' : '',
        })} to={""} className="hover:text-Primary-color transition ease-in-out duration-400 font-semibold">Notice</NavLink>
      <NavLink  style={({ isActive }) => ({
          color: isActive ? '#f36730' : '',
